var size = 0;
function categories_schools2(feature, value) {
...
default:
        ...
        image: new ol.style.Circle({radius: 4.8 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(183,87,228,1.0)'})})
                    ...
                    break;}};
var styleCache_schools2={}
var style_schools2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("POI_CHAR");
    var style = categories_schools2(feature, value);
    if ("" !== null) {
    ...
    if (!styleCache_schools2[key]){
        ...
        styleCache_schools2[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_schools2[key]];
