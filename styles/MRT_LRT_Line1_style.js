var size = 0;
function categories_MRT_LRT_Line1(feature, value) {
...
default:
        ...
        stroke: new ol.style.Stroke({color: 'rgba(31,120,180,1.0)', lineDash: null, lineCap: 'round', lineJoin: 'round', width: 4}),
                    ...
                    break;
case 'Downtown Line MRT (U/C)':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(31,120,180,1.0)', lineDash: null, lineCap: 'round', lineJoin: 'round', width: 4}),
    })];
                    break;}};
var styleCache_MRT_LRT_Line1={}
var style_MRT_LRT_Line1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("name");
    var style = categories_MRT_LRT_Line1(feature, value);
    if ("" !== null) {
    ...
    if (!styleCache_MRT_LRT_Line1[key]){
        ...
        styleCache_MRT_LRT_Line1[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_MRT_LRT_Line1[key]];
